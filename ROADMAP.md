...
- [ ] CRITICAL: Update Projects Using Removed Log Scripts
  - Create a migration guide explaining the removal of clear-logs.js
  - Add detection in init.py to scan for references to clear-logs.js and warn users
  - Provide example sed/grep commands to update shell scripts automatically
  - Document how to replace references with appropriate check-logs.js commands
